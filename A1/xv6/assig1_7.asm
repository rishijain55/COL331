...
int main(void)
{
   ...
   e:	51                   	push   %ecx
	toggle(); 
   f:	e8 a7 03 00 00       	call   3bb <toggle>
	printf(1,"%s\n","IPC Test case");
  14:	83 ec 04             	sub    $0x4,%esp
  17:	68 c8 07 00 00       	push   $0x7c8
  1c:	68 d6 07 00 00       	push   $0x7d6
  21:	6a 01                	push   $0x1
...
int cid = fork();
  ...
  37:	6a 08                	push   $0x8
  39:	e8 92 06 00 00       	call   6d0 <malloc>
  ...
  71:	6a 08                	push   $0x8
  73:	e8 58 06 00 00       	call   6d0 <malloc>
		msg_child = "P";
		printf(1,"1 PARENT: msg sent is: %s \n", msg_child );
  78:	83 c4 0c             	add    $0xc,%esp
  7b:	68 f5 07 00 00       	push   $0x7f5
  ...
  9b:	e8 33 03 00 00       	call   3d3 <send>
		...
		free(msg_child);
  a0:	c7 04 24 f5 07 00 00 	movl   $0x7f5,(%esp)
  a7:	e8 94 05 00 00       	call   640 <free>
	}
	wait();
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 74 08 00 00 	movzbl 0x874(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 1c 08 00 00 	jmp    *0x81c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 13 08 00 00       	mov    $0x813,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 20 0b 00 00       	mov    0xb20,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 20 0b 00 00    	mov    %edx,0xb20
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 20 0b 00 00    	mov    %edx,0xb20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 20 0b 00 00    	mov    0xb20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 20 0b 00 00    	mov    0xb20,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 20 0b 00 00    	mov    0xb20,%edx
 ...
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 24 0b 00 00       	mov    $0xb24,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 28 0b 00 00 00 	movl   $0x0,0xb28
 7b2:	00 00 00 
    if(p->s.size >= nunits){
