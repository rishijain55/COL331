...
main(void)
{
  ...
  11:	e8 35 03 00 00       	call   34b <toggle>
  ...
  20:	e8 0b 04 00 00       	call   430 <printf>
	int cid = fork();
  25:	e8 71 02 00 00       	call   29b <fork>
	if(cid!=0){
  ...
  2f:	75 0a                	jne    3b <main+0x3b>
	...
	wait();
  31:	e8 75 02 00 00       	call   2ab <wait>
	exit();
  36:	e8 68 02 00 00       	call   2a3 <exit>
		print_count();
  3b:	e8 1b 03 00 00       	call   35b <print_count>
		toggle();		
  40:	e8 06 03 00 00       	call   34b <toggle>
  45:	eb ea                	jmp    31 <main+0x31>
  47:	66 90                	xchg   %ax,%ax
  49:	66 90                	xchg   %ax,%ax
  4b:	66 90                	xchg   %ax,%ax
  4d:	66 90                	xchg   %ax,%ax
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 6b 07 00 00       	mov    $0x76b,%edx
        while(*s != 0){
