...
_assig1_4:     file format elf32-i386
...
main(void)
{
  ...
  11:	6a fa                	push   $0xfffffffa
  13:	6a 0a                	push   $0xa
  15:	e8 09 03 00 00       	call   323 <add>
  1a:	83 c4 0c             	add    $0xc,%esp
  1d:	50                   	push   %eax
  1e:	68 38 07 00 00       	push   $0x738
  23:	6a 01                	push   $0x1
  25:	e8 e6 03 00 00       	call   410 <printf>
	exit();
  2a:	e8 54 02 00 00       	call   283 <exit>
  2f:	90                   	nop
 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 b0 07 00 00 	movzbl 0x7b0(%edx),%edx
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 58 07 00 00 	jmp    *0x758(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 51 07 00 00       	mov    $0x751,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 58 0a 00 00       	mov    0xa58,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 58 0a 00 00    	mov    %edx,0xa58
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 58 0a 00 00    	mov    %edx,0xa58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 58 0a 00 00    	mov    0xa58,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d 58 0a 00 00    	mov    0xa58,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 58 0a 00 00    	mov    0xa58,%edx
 ...
 707:	0a 00 00 
    base.s.size = 0;
 70a:	bf 5c 0a 00 00       	mov    $0xa5c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 60 0a 00 00 00 	movl   $0x0,0xa60
 722:	00 00 00 
    if(p->s.size >= nunits){
