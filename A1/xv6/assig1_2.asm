...
main(int argc, char *argv[])
{
  ...
  toggle();
  11:	e8 25 03 00 00       	call   33b <toggle>
  // fork(); 
  int fd = open("arr", 0);
  16:	83 ec 08             	sub    $0x8,%esp
  19:	6a 00                	push   $0x0
  1b:	68 48 07 00 00       	push   $0x748
  20:	e8 ae 02 00 00       	call   2d3 <open>
  close(fd);
  25:	89 04 24             	mov    %eax,(%esp)
  28:	e8 8e 02 00 00       	call   2bb <close>
  print_count();
  2d:	e8 19 03 00 00       	call   34b <print_count>
  exit();
